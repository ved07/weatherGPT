      ...
      <View className="w-full flex flex-col h-full px-4 max-w-screen-2xl">
        ...
        <View className="mb-6">
          <View className="flex flex-row justify-between items-center mb-1">
            <Text>Lowest temperature: <Text className="font-bold">{(temperature - 10.0).toFixed(1)}°C</Text></Text>
            <SettingSlider
          ...
          <View className="flex flex-row justify-between items-center mb-1">
            <Text>Highest rainfall: <Text className="font-bold">{rainfall.toFixed(1)}%</Text></Text>
            <SettingSlider
          ...
          <View className="flex flex-row justify-between items-center mb-2">
            ...
            <TimeSwitch defaultValue={settings.secondaryMethod === 'walk'} onChange={(value) => setSettings({...settings, secondaryMethod: value ? 'walk' : 'bus'})} />
          </View>
          ...
          <View className="flex flex-row justify-between items-center mb-2">
            ...
            <TextInput
              ...
              onEndEditing={(e) => setSettings({...settings, secondaryMultiplier: parseFloat(backupMethodMultiplier) || 2.0})}
          ...
          <View className="flex flex-row justify-between items-center mb-2">
            ...
            <TextInput
              ...
              onEndEditing={(e) => setSettings({...settings, maxWaitTime: parseFloat(maxWaitTime) || 60})}
              keyboardType="numeric"
            />
          </View>
          ...
          <View className="flex flex-row justify-between items-center mb-2">
            <Text>Location</Text>
            <Text className="rounded-md border-2 py-1 px-2 border-gray-400 w-32 bg-gray-300">Cambridge</Text>
          </View>
        </View>
