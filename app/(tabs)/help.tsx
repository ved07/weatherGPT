  ...
  return (
    <Background>
      <View style={{
        ...
        <TextBlog text = {"What’s unique about this app?"} hidden = {"As cyclists, all too often we show up to our destinations soaking wet. No more! This app will let you know when the weather is good to cycle in. "} />
        <TextBlog text = {"How do I change my routes?"} hidden = {"Press the button labelled 'settings' at the bottom of the screen, and then tap in your location for the day you want to change your route for."} />
