...
export default function HelpScreen() {
  return (
    <Background>
      <View>
        <TextBlog text = {"HELP"} hidden = {""} textStyle = {styles.exo2BoldText} title = {true} />
        <TextBlog text = {"FAQs"} hidden = {""} textStyle = {styles.farroBoldText} />
        ...
        <TextBlog text = {"Any other Questions?\n Contact our Support Team!"}  textStyle= {styles.exo2RegularText}
